...
<div>
          ...
          <button className={`text-sm text-white px-2 ${email_Error ? " bg-green-500" : "bg-gray-700"}  ${email === "" ? "hidden" : "mb-[13px]"}`}>Verify Email</button>
...
<button
    className="flex  text-white border  border-gray-300 rounded-lg shadow-md px-[21%] py-2 md:text-lg text-xs font-medium w-full p-3 hover:text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
