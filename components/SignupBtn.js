...
const SignupBtn = ()  => {
  ...
  return (
    ...
    <button
    type="button"
    className="text-white bg-gradient-to-r from-purple-600 via-purple-700 to-purple-900 hover:bg-gradient-to-br font-medium rounded-lg text-xl xl:text-xl 2xl:text-3xl px-4 py-1 xl:px-6 xl:py-2 2xl:px-8 2xl:py-4"
